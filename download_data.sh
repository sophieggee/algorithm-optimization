...
LABS=("BinaryTrees" "BreadthFirstSearch" "CVXPY_Intro" "Exceptions_FileIO" "FourierTransform" "GradientMethods" "InteriorPoint_Linear" "LinkedLists" "MarkovChains" "NMF" "NearestNeighbor" "PolynomialInterpolation" "PythonAndNumpy2" "RegularExpressions" "Simplex" "UnixShell2")
